...
describe.skipIf(!INSTANCE)("write path against a live instance", () => {
  ...
  // Regression: identical content is convergence.
  ...
  // Regression: the refusal rule ignores other roots,
  ...
  // Regression: typed openGadget codes render.
  ...
  // Regression: a foreign edit inside the push
