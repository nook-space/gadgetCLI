...
describe.skipIf(!INSTANCE)("auth against a live instance", () => {
  ...
  // Regression (phase-1 critique blocker 1a): two lines piped to stdin must feed two
  ...
  // Regression (phase-1 critique blocker 1b): EOF stdin with no password must fail
